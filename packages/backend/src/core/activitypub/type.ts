...
export interface IOrderedCollection extends Omit<ICollection, 'type'> {
...
export interface IOrderedCollectionPage extends Omit<IOrderedCollection, 'type'>, Omit<ICollectionPage, 'type'> {
